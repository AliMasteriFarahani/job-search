<template>
  <div>
              <header class="container-fluid bg-white position-fixed p-0 z-index-lv1 shadow-0-c">
            <div class="container-fluid container-lg bg-white">
                <nav class="navbar navbar-expand-lg pb-0 navbar-light bg-white ">
                    <div class="container-fluid d-flex flex-row-reverse">
                        <div id="logo" class="d-flex order-lg-1">
                            <!-- <router-link :to="{name:'LoginRegister'}"
                                ...
                                <div v-if="isLogin" class="dropdown me-lg-5 drop-acc" >
                                    ...
                                    <button class="btn btn-sm btn-icon dropdown-toggle rounded-5 font-102 py-0 d-lg-none d-block" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <div class="collapse navbar-collapse order-4" id="navbarNavAltMarkup">
                            <div class="navbar-nav ">
                                <router-link :to="{name:'Home'}" class="nav-link m-2" aria-current="page" href="index.html">خانه</router-link>
                                <router-link :to="{name:'JobSearch'}" class="nav-link m-2" href="#">جست و جوی مشاغل </router-link>
                                <a class="nav-link m-2" href="#">ساخت رزومه</a>
