        ...
        <form action="">
          <div class="row">
            ...
            >
              ...
              >
                <select >
                  ...
                  <option v-for="(province,index) in getProvinces" :key="index" :value="province.id">{{province.name}}</option>
                <!-- <select id="provinces" v-for="(province,index) in prov" :key="index">
            ...
            >
              ...
              >
                <select>
                  ...
                  <option  v-for="(cat,index) in getCategories" :key="index" :value="cat.id">{{cat.title}}</option>
            ...
            <div class="col-md-6 col-lg-2 col-12 offset-md-3 offset-lg-0">
              <button class="btn btn-warning h-100 w-100 font-95">
                جست و جو
              </button>
            </div>
          </div>
